...
// reactbits LightPillar (three.js), pulled from the project brief. ONE change from
// the reference source: the 'high' quality tier's pixelRatio is capped at 1 (was
// Math.min(devicePixelRatio, 2)) so the pillar honours our DPR-cap-1 rule. Its own
// quality system still auto-downgrades on mobile / low-end devices. Everything else
// — the two-stop gradient shader, rotation, glow, film-grain noise — is verbatim.
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      ...
      high: {
        iterations: 80,
        waveIterations: 4,
        pixelRatio: Math.min(window.devicePixelRatio, 1), // DPR CAP 1 (ref was 2)
        precision: 'highp',
        stepMultiplier: 1.0
      }
    };
