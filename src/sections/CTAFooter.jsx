      ...
      <div className="relative z-10 mx-auto flex w-full flex-1 flex-col items-center justify-center px-6 py-32 text-center" style={{ color: '#fdfaf4' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4" style={{ fontFamily: INTER }}>
          <a
            ...
            className="btn-nebula focus-ring inline-flex h-14 items-center justify-center rounded-[var(--r-btn)] bg-[#D99637] px-10 text-[15px] font-semibold text-[#0f2444] transition-all duration-300 hover:bg-[#E8B45F] hover:scale-[1.02] active:scale-[0.98]"
            ...
            <div className="mb-8 flex items-end justify-between">
              ...
              <div className="flex items-center gap-3">
                {['LinkedIn', 'Instagram', 'Facebook'].map((net) => (
                  <a key={net} href="#" className="group flex h-10 w-10 items-center justify-center rounded-full bg-[#0f2444]/6 transition-all hover:bg-[#D99637]/20 hover:scale-110 active:scale-95" aria-label={net}>
