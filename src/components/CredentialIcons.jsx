...
const GOLD = '#B06F15'
const GOLD_HOVER = '#B18120'
const STROKE_WIDTH = 1.5

export function CertificateIcon() {
  return (
    <svg viewBox="0 0 32 32" width="32" height="32" fill="none" stroke={GOLD} strokeWidth={STROKE_WIDTH} strokeLinecap="round" strokeLinejoin="round" className="transition-colors duration-200 group-hover:stroke-[#B18120]">
      {/* Seal/badge shape */}
