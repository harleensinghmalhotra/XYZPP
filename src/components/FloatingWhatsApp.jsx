...
// but below the gallery lightbox (z-1000) and the cookie banner (z-200).
const WA_NUMBER = '918291999922' // matches Contact.jsx PHONE_TEL / WA_URL
const WA_PREFILL = "Hello Quarterfold, I'd like to discuss a printing project."
const WA_HREF = `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(WA_PREFILL)}`

export default function FloatingWhatsApp() {
  const { t } = useTranslation('whatsapp')
  const [shown, setShown] = useState(false)

  // Gentle entrance after 1.5s (CSS handles the transition + reduced-motion).
  useEffect(() => {
