...
const TONES = {
  navy: ['rgba(177, 129, 32,0.55)', 'rgba(253,250,244,0.28)'], // gold + faint cream dots on navy
  warm: ['rgba(176, 111, 21,0.30)', 'rgba(3,12,49,0.12)'],    // gold + faint navy dots on cream/beige
}
...
export function EdgeGlow({ tone = 'navy', className = '' }) {
  const g = tone === 'warm'
    ? 'radial-gradient(680px 460px at 8% 0%, rgba(177, 129, 32,0.10), transparent 60%), radial-gradient(760px 520px at 100% 100%, rgba(3,12,49,0.06), transparent 62%)'
    : 'radial-gradient(760px 520px at 4% 6%, rgba(177, 129, 32,0.14), transparent 60%), radial-gradient(820px 560px at 100% 96%, rgba(27,58,107,0.5), transparent 62%)'
