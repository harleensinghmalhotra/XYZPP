...
export default function Contact() {
  ...
  return (
    <main id="main" ref={root}>
          ...
          <PageHero id="ctc-h1" eyebrow={t('hero.eyebrow')} line1={l1} line2={l2} subline={t('hero.line')} minVh={62}>
            <div className="ph-stat" aria-label={t('hero.callAriaLabel')}>
              <div className="ctc-hero-reach">
                <a className="ph-stat-num ph-stat-num--text" href={`mailto:${EMAIL_INFO}`}>{EMAIL_INFO}</a>
      ...
      {/* The page's own "Print Something That Matters" navy closing band was removed
          (client): it duplicated the site-wide footer CTA that follows directly below. */}
    </main>
  )
}
